...
- Diwakar V. Singh: Implementation of whole CycleGAN pipeline using TensorFlow API in Google Colab; Model training on 2 different datasets: Monet and Cezanne; Model training for different generative architectures and padding types; Final results generation; Supervising all the experiments.
